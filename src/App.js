...
import WantToReadRow from './WantToReadRow';
import ReadBooksRow from './ReadBooksRow';
import './App.css';
        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
              <CurrentlyReadingRow currentBooks={this.state.currentBooks} />
                ...
                <WantToReadRow wantToReadBooks={this.state.wantToReadBooks} />
                <ReadBooksRow readBooks={this.state.readBooks} />
                {/*<div className="bookshelf">
